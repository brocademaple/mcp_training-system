...
**创建日期**: 2026-01-10  
**最近更新**: 2026-03（PRD 主线对齐 2.0；经典版作为并存能力保留）

> **说明**：下文**产品目标与架构**以 **2.0** 为默认叙述；**1.0 / 经典版**指「手动逐步完成数据→训练→评估」的并存模式，与 Agent 版**共用同一数据库与 API**。详细路线、工作台定位与技术升级见 [`docs/PLANNING_2.0.md`](docs/PLANNING_2.0.md)、[`docs/SPEC_CODING.md`](docs/SPEC_CODING.md)。
